...
if(isset($_POST['save_settings'])){
    ...
    $id="1";
    $sql = "UPDATE settings SET url_name=:url_name,url_tel=:url_tel,about_us=:about_us,url_email=:url_email,livechat=:livechat,trans_limit_min=:trans_limit_min,trans_limit_max=:trans_limit_max WHERE id=:id";
    $stmt = $conn->prepare($sql);
    $stmt->execute([
        'url_name'=>$url_name,
        'url_tel'=>$url_tel,
                                            ...
                                            <div class="row"> 
                                                <div class="col-xl-12  text-center"> 
                                                    <div class="upload mt-4 pr-md-4"> 
                                                        <center> 
                                                            <input type="file" id="input-file-max-fs" class="dropify" data-default-file="./uploads/<?= $page['image']?>" name="image" data-max-file-size="2M" /> 
                                                        </center> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mb-4" rows="3" id="textarea-copy" placeholder="About Bank" value="" name="about_us" style="resize: none" required><?=$page['about_us']?></textarea>
                                </div>
                            </div>
